...
(2, 5, 14, 4.0, 'Aerolite', '2.0/2.3-0.9/2.0'),
(2, 5, 14, 4.0, 'Revolite', '2.0/2.3-1.3/2.0'),
(2, 5, 14, 5.7, 'Complite', '2.0/2.3-1.5/2.0'),
...
--  Aero
(4, 5, 14, 3.3, 'mac Aero 330', '2.0/1.8-0.9/2.0'),
(4, 5, 14, 3.6, 'mac Aero 360', '2.0/2.0-0.9/2.0'),
(4, 5, 13, 8.6, 'mac Aero 373', '2.3/3.2-1.5/2.3'),
(4, 5, 13, 8.6, 'mac Aero 374T', '2.3/3.2-1.4/2.0'),
(4, 5, 13, 8.6, 'mac Aero 383', '2.3/4.3-1.3/2.3'),
(4, 5, 13, 8.5, 'mac Aero 384T', '2.3/4.3-1.3/2.0'),
(4, 5, 13, 8.6, 'mac Aero 393', '2.3/5.0-1.1/2.3'),
(4, 5, 13, 8.5, 'mac Aero 394T', '2.3/5.0-1.1/2.0'),
(4, 5, 14, 4.7, 'mac Aero 416', '2.0/2.2-1.0/2.0'),
(4, 5, 14, 5.1, 'mac Aero 417', '2.0/2.2-1.1/2.0'),
(4, 5, 14, 5.6, 'mac Aero 418', '2.0/2.2-1.2/2.0'),
(4, 5, 14, 4.2, 'mac Aero 424', '2.0/2.2-0.9/2.0'),
(4, 5, 14, 6.5, 'mac Aero 474', '2.0/2.3-1.5/2.0'),
(4, 5, 14, 6.5, 'mac Aero 494', '2.0/3.0-1.2/2.0'),
(4, 5, 14, 6.5, 'mac Aero 494C', '2.0/3.5-1.1/2.0'),
(4, 5, 15, 4.4, 'mac Aero 565', '1.8/2.2-1.0/1.8'),
(4, 5, 15, 5.4, 'mac Aero 585', '1.8/2.3-1.2/1.8'),
(4, 5, 15, 5.4, 'mac Aero 595', '1.8/3.0-1.0/1.8'),
(4, 5, 13, 5.6, 'mac Aries 384', '2.3/2.5-1.2/2.0'),
(4, 5, 13, 6.6, 'mac Bravo 374', '2.3/2.3-1.5/2.0'),
(4, 5, 15, 6.5, 'mac Bravo 394', '2.3/3.0-1.2/2.0'),
...
--  Aero
(5, 5, 14, 6.5, 'One Aero', '2.0/2.3-1.7-2.0'),
(5, 5, 14, 5.7, 'Basiclite Aero', '2.0/2.3-1.4/2.0'),
(5, 5, 14, 5.7, 'Extralite Aero', '2.0/2.3-1.2/2.0'),
(5, 5, 14, 4.3, 'Superlite Aero', '2.0/2.3-1.1/2.0'),
(5, 5, 14, 4.3, 'Ultralite Aero', '2.0/2.3-0.9/2.0'),
(5, 5, 14, 3.3, 'Hyperlite Flat', '2.0/2.2/2.0-0.9/2.2/2.0'),
